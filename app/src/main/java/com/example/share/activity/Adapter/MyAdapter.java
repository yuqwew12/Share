...
import com.example.share.activity.Fragment.LikeFragment;

import java.util.List;

public class MyAdapter extends ArrayAdapter<LikeFragment.LikeResponse.LikeData.Record> {
    public MyAdapter(Context context, List<LikeFragment.LikeResponse.LikeData.Record> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        LikeFragment.LikeResponse.LikeData.Record record = getItem(position);
